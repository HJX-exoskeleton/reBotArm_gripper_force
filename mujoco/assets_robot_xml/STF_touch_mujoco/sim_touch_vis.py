...
# 加载模型
m = mujoco.MjModel.from_xml_path('/home/hjx/hjx_file/rebot_devarm_ws/reBotArm_gripper_force/mujoco/assets_robot_xml/STF_touch_mujoco/xml/sim_touch_stf.xml')
d = mujoco.MjData(m)
