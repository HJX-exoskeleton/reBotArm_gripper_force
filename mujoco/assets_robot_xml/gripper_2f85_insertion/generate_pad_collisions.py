...
FLAGS = flags.FLAGS
flags.DEFINE_integer('nx', 16, 'Number of pads in x direction')
flags.DEFINE_integer('ny', 16, 'Number of pads in y direction')
...
def main(_):
    ...
    f = open("/home/hjx/hjx_file/mujoco_hjx_project/assets/robots/gripper_2f85_insertion/right_pad_collisions.xml", "w")
    f.write("<mujoco>\n")
    for i in range(dy):
    ...
    shutil.copyfile("/home/hjx/hjx_file/mujoco_hjx_project/assets/robots/gripper_2f85_insertion/right_pad_collisions.xml", "/home/hjx/hjx_file/mujoco_hjx_project/assets/robots/gripper_2f85_insertion/left_pad_collisions.xml")
    ...
    f = open("/home/hjx/hjx_file/mujoco_hjx_project/assets/robots/gripper_2f85_insertion/touch_sensors.xml", "w")
